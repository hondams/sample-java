package com.github.hondams.fw.test.sample.mockito;
...
import com.github.hondams.fw.test.target.TestSampleInstanceMethods;

@ExtendWith(MockitoExtension.class)
class InstanceMethodsSpyTest {
    ...
    void test_invokeStringReturnMethodByArg_ArgOnly() {
        ...
        // 未設定の引数は、実メソッドを実行する。
        assertEquals("invokeStringReturnMethodByArg:0:0",
                this.instanceMethods.invokeStringReturnMethodByArg("0"));
    }
