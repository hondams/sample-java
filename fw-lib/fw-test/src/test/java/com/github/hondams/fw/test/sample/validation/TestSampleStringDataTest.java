...
class TestSampleStringDataTest {
    ...
    private static Stream<Object[]> provideTestDataForTestValidation() {
        ...
        return Stream.of(
                ...
                new Object[] {
                        List.of("「Stringの非空白の値」は、1 文字以上にしてください"),
                        noErrorBuilder()
                                .notEmptyValue("")
                },
                new Object[] {
                        List.of("「Stringの文字数指定の値」は、1 文字以上、10 文字以下にしてください"),
                        noErrorBuilder()
                                .sizeValue("")
                },
                new Object[] {
                ...
                new Object[] {
                        List.of("「Stringのパターン指定の値」は、半角英数字にしてください"),
                        noErrorBuilder()
                                .patternValue("-")
                });
    }
